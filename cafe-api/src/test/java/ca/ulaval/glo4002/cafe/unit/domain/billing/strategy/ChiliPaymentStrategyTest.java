...
class ChiliPaymentStrategyTest {
  ...
  private static final BigDecimal TAX_AMOUNT = new BigDecimal("1.90");
  ...
  @Test
  void givenAListOfProductAndIsClientIsInGroup_whenGeneratingBillWithChiliStrategy_thenReturnBillWithIncludingGroupTip() {
    ChiliPaymentStrategy chiliPaymentStrategy = new ChiliPaymentStrategy(GROUP_TIP_RATE);

    Bill bill = chiliPaymentStrategy.generateBill(productList, CLIENT_IS_IN_GROUP);
  ...
  @Test
  void givenAListOfProductAndIsClientIsNotInGroup_whenGeneratingBillWithChiliStrategy_thenReturnBillWithoutIncludingGroupTip() {
    ChiliPaymentStrategy chiliPaymentStrategy = new ChiliPaymentStrategy(GROUP_TIP_RATE);

    Bill bill = chiliPaymentStrategy.generateBill(productList, CLIENT_NOT_IN_GROUP);
